...
exports.favoriteMoivesRouter.post('/', requireLogin_1.default, clearCache_1.default, awaithandler_1.default(movies.post));
exports.favoriteMoivesRouter.delete('/:id', requireLogin_1.default, clearCache_1.default, awaithandler_1.default(movies.delete));
